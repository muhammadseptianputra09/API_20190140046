...
import com.example.webservice.exceptions.NonexistentEntityException;
import com.example.webservice.exceptions.PreexistingEntityException;
...
public class PenjualanJpaController implements Serializable {
    ...
    public void create(Penjualan penjualan) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findPenjualan(penjualan.getId()) != null) {
